...
<body><div class="head">
	<div class="head_area">
		<div class="head_nav">
			<ul>
				<li><img src="${pageContext.request.contextPath}/user/images/nav_inc1.png" /><a href="${pageContext.request.contextPath}/indexUser" target="_parent">首页</a></li>
				<li><img src="${pageContext.request.contextPath}/user/images/nav_inc2.png" /><a href="#">成功案例</a></li>
				<li><img src="${pageContext.request.contextPath}/user/images/nav_inc3.png" /><a href="#">关于锐聘</a></li>
			</ul>
		</div>
