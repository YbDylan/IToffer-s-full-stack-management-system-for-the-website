...
<div class="topleft"> 
<a href="main.jsp" target="_parent"><img src="${pageContext.request.contextPath}/admin/images/main_logo.png" title="系统首页" /></a> </div>
...
<ul class="nav">
  <li><a href="" target="_blank" class="selected"><img src="${pageContext.request.contextPath}/admin/images/globe.png" title="网站前台" />
    <h2>网站前台</h2>
    </a></li>
  <li><a href="index.jsp" target="rightFrame"><img src="${pageContext.request.contextPath}/admin/images/home.png" title="后台首页" />
    <h2>后台首页</h2>
    </a></li>
</ul>
</body>
