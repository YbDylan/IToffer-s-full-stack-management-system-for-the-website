...
<dl class="leftmenu">
  <dd>
    ...
    <ul class="menuson">
      <li><cite></cite><a href="${pageContext.request.contextPath}/admin/page/job/jobApplyList.jsp" target="rightFrame">职位申请查看</a><i></i></li>
  ...
  <dd>
    ...
    <ul class="menuson">
      <li><cite></cite><a href="${pageContext.request.contextPath}/allResume" target="rightFrame">简历查询</a><i></i></li>
    </ul>
  </dd>
  <dd>
    <div class="title"><span><img src="${pageContext.request.contextPath}/admin/images/leftico03.png"/></span>用户管理</div>
  	<ul class="menuson">
      <li><cite></cite><a href="${pageContext.request.contextPath}/findAdmin" target="rightFrame">用户管理</a><i></i></li>
    </ul>
  </dd>
  <dd>
    <div class="title"><span><img src="${pageContext.request.contextPath}/admin/images/leftico04.png" /></span>系统管理</div>
    <ul class="menuson">
      <li><cite></cite><a href="${pageContext.request.contextPath}/admin/page/info/userOnline.html" target="rightFrame">在线用户</a><i></i></li>
    </ul>
  </dd>
  <dd>
