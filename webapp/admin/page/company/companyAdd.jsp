...
<div class="formbody">
  <div class="usual">
  <form name="frm" action="${pageContext.request.contextPath}/saveCompany" method="post" enctype="multipart/form-data" onsubmit="return validate();">
    <div class="tabson">
      <ul class="forminfo">
      	<li>
        ...
        <li>
          ...
          <input name="companyLoc" type="text" id="companyArea" class="dfinput" style="width:518px;"/>
        </li>
        <li>
        ...
        <li>
          <p>企业简介&nbsp;(不超过1000字)</p>
          <textarea class="ckeditor" cols="50" id="companyBrief" name="companyDesc" rows="10"></textarea>
        </li>
        <li>
          <label>企业招聘状态</label>
          <div class="vocation">
            <select name="companyStatus" class="select3">
        ...
        <li>
          ...
          <input name="companyNum" type="text" class="dfinput" style="width:100px;"/>
        </li>
         <li>
