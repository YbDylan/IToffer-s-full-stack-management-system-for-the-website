...
public class AdminDao {
    //登录dao
    public Admin adminLogin(String adminLogin,String adminPwd){
        Connection conn  = null;
        PreparedStatement psta = null;
        ResultSet resultSet = null;
        try {
           conn = DBUtil.getConn();
           String sql = "select *   from adminin where admin_login=? and admin_pwd=?";
    ...
    //添加admin信息
    public int addAdmin(String adminLogin,String adminPwd,String adminName,String adminEmail,
                        String adminRole,int adminStatus){
        Connection conn = null;
        PreparedStatement psta = null;
        try {
            conn = DBUtil.getConn();
            String sql = "insert into adminin(admin_login,admin_pwd,admin_name,admin_email," +
    ...
    //修改用户状态
    public int updateAdminStatus(int adminStatus,int adminId){
        Connection conn = null;
        PreparedStatement psta = null;
        try {
            conn = DBUtil.getConn();
            String sql ="update adminin  set admin_status = ? where admin_id=?";
            psta = conn.prepareStatement(sql);
    ...
    public Admin getAdminById(int adminId){
        ...
        try {
            conn = DBUtil.getConn();
            String sql = "select *  from  adminin where admin_id=?";
            psta = conn.prepareStatement(sql);
    ...
    public int updateAdmin(Admin admin){
        ...
        try {
            conn = DBUtil.getConn();
            String sql = "update  adminin  set  admin_login=?,admin_name=?,admin_pwd=?,admin_email =?,admin_role=? where  admin_id=?";
            psta = conn.prepareStatement(sql);
